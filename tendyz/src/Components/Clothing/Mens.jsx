...
export const Mens = ()=>{
    ...
    const ShowProd = ()=>{
        return (
            ...
            <div >
                <img className="hero_img_div" src="https://imgs.search.brave.com/i9Lm5L4xuxHLed2m5k42ZKC8_M0wCYtKpMR4lKJq9XE/rs:fit:1188:225:1/g:ce/aHR0cHM6Ly90c2Ux/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5x/clpyWXBGWXhXYUFZ/OF9CMmRSMExBSGFD/OSZwaWQ9QXBp" alt="" />
            ...
            <div className="category">
                <div >
                    <Link to="/mens">
                        <img onClick={()=>filterProd("men's clothing")} src="https://imgs.search.brave.com/TSmQEVPZ-8_97QvU_uuY5SclTHQVomHxQL5dkDZoLZo/rs:fit:380:225:1/g:ce/aHR0cHM6Ly90c2Uy/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5O/bzdpZmlpMGd2SVpf/b0d1NE1XczlBSGFK/UCZwaWQ9QXBp" alt="men" />
                        <h2>Mens</h2>
                    </Link>
                </div>
                <div>
